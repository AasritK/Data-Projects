...
select total_vaccinations,location,date from PortfolioProject..CovidVaccinations
order by date desc


--Vaccinations in India
select location, Max(total_vaccinations) as HighestVaccination from PortfolioProject..CovidVaccinations
